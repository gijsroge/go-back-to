...
export default function DetailInfo() {
  ...
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto" }}>
      ...
      <div>
        <h1 style={{ fontSize: "2.5rem", marginBottom: "1rem", color: "#333" }}>Details</h1>
        <p style={{ fontSize: "1.1rem", marginBottom: "2rem", color: "#666" }}>
          This is the details page. Scroll down to test scroll position preservation.
        </p>
        {Array.from({ length: 20 }, (_, i) => (
          ...
          >
            <h3 style={{ marginBottom: "1rem", color: "#333" }}>Detail Section {i + 1}</h3>
            <p style={{ color: "#666" }}>
